...
Enemy::Enemy(glm::vec3 position)
{
	...
	// Idle
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_s_1.png")); //0

	// Walk
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_w1_1.png")); //1
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_w2_1.png")); //2
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_w3_1.png")); //3
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_w4_1.png")); //4

	// Attack
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_shoot1.png")); //5
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_shoot2.png")); //6
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_shoot3.png")); //7

	// Hurt
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_pain1.png")); //8
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_pain2.png")); //9

	// Death
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_die1.png")); //10
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_die2.png")); //11
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_die3.png")); //12
	animations_.push_back(new Texture("Textures/Enemy/pngs/mguard_die4.png")); //13
...
{
	double time = Time::GetTime() - (int)Time::GetTime();
