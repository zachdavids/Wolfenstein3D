...
LevelGenerator::LevelGenerator(std::string const& filename) : 
	m_FileName(filename)
{
	m_Lua.open_libraries(sol::lib::base);
}

bool LevelGenerator::TryGenerate()
{
...
//void LevelGenerator::ParseLevel(pugi::xml_node const& level_node)
//{
...
//void LevelGenerator::ParseTiles(pugi::xml_node const& level_node)
//{
...
//std::vector<Node>& LevelGenerator::GetNodes()
//{
//	//return m_Nodes;
//}
//
//glm::ivec2 LevelGenerator::GetDimensions()
//{
//	//return m_Dimensions;
//}