...
Player::Player(glm::vec3 position, int yaw, int pitch)
{
	...
	animations_.push_back(new Texture("Textures/Enemy/pngs/s1_1.png"));
	animations_.push_back(new Texture("Textures/Enemy/pngs/s2_2.png"));
	animations_.push_back(new Texture("Textures/Enemy/pngs/s3_3.png"));
	animations_.push_back(new Texture("Textures/Enemy/pngs/s4_4.png"));
	animations_.push_back(new Texture("Textures/Enemy/pngs/s5_5.png"));
	
	animations_2.push_back(new Texture("Textures/Numbers/0.png"));
	animations_2.push_back(new Texture("Textures/Numbers/1.png"));
	animations_2.push_back(new Texture("Textures/Numbers/2.png"));
	animations_2.push_back(new Texture("Textures/Numbers/3.png"));
	animations_2.push_back(new Texture("Textures/Numbers/4.png"));
	animations_2.push_back(new Texture("Textures/Numbers/5.png"));
	animations_2.push_back(new Texture("Textures/Numbers/6.png"));
	animations_2.push_back(new Texture("Textures/Numbers/7.png"));
	animations_2.push_back(new Texture("Textures/Numbers/8.png"));
	animations_2.push_back(new Texture("Textures/Numbers/9.png"));
